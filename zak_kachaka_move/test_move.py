...
class Follower(Node):
    def __init__(self) -> None:
        ...
        self._lidar_subscriber = self.create_subscription(LaserScan, "/kachaka/lidar/scan", self._laser_scan_callback, 10)
    ...
    def _laser_scan_callback(self, msg: LaserScan) -> None:
        ...
        if valid_ranges:
            ...
            self._closest_angle = angles.normalize_angle(msg.angle_min + (min_index * angle_increment) + (math.pi / 2))
